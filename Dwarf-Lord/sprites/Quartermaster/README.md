...
**Role:** Blond quartermaster design; Fenn.

**Age:** Adult.

**Identity:** Forked blond beard, receding blond hair, weathered broad face, olive waistcoat and multiple leather pouches.

**Consistency:** Preserve blond identity and pouches; not Borrin.
...
Six additional character-and-workstation compositions are in `work-references/`. Review `work-references/review.jpg` and `work-references/manifest.json`. Actions: Record inventory, Explain allocations, Examine tool, Count supplies, Repair satchel, Check weights. These are static references; animation variations are the next pass.
