...
**Role:** Camp cook design; Kori.

**Age:** Adult.

**Identity:** Ruddy round face, thinning brown hair, bushy moustache and shorter brown beard; stout belly, burgundy shirt and stained cream apron.

**Consistency:** Preserve apron and round silhouette; alpha must not contain painted checkerboard.
...
Six additional character-and-workstation compositions are in `work-references/`. Review `work-references/review.jpg` and `work-references/manifest.json`. Actions: Chop vegetables, Peel potatoes, Knead dough, Stir cauldron, Mix ingredients, Serve stew. These are static references; animation variations are the next pass.
