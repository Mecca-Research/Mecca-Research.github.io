...
**Role:** Dwarf laborer design; Tam.

**Age:** Adult.

**Identity:** Bald, brown braided beard with brass cuffs; cream rolled sleeves, brown leather vest, short stocky dwarf proportions and oversized hands/boots.

**Consistency:** Do not substitute the separate Human Laborer.
...
Six additional character-and-workstation compositions are in `work-references/`. Review `work-references/review.jpg` and `work-references/manifest.json`. Actions: Lift crate, Carry sack, Push stone barrow, Pull supply sled, Build crate, Sweep wood chips. These are static references; animation variations are the next pass.
