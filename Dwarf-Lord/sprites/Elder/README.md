...
**Role:** Oldest resident; speaking/rumor NPC with evolving narrative roles.

**Age:** Oldest dwarf.

**Identity:** Bald crown, deeply wrinkled kindly face, long flowing white beard; heavy moss-brown wool coat; both hands resting on a walking stick.

**Consistency:** Not the manager or ledger operator. Never assign ordinary labor/wages or use this art for Borrin.
...
Six additional character-and-workstation compositions are in `work-references/`. Review `work-references/review.jpg` and `work-references/manifest.json`. Actions: Eat stew, Eat bread, Laugh seated, Laugh and gesture, Inspect pickaxe in lap, Examine pickaxe crack. These are static references; animation variations are the next pass.
