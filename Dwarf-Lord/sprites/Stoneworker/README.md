...
**Role:** Stoneworker design; Hob and Stig.

**Age:** Adult.

**Identity:** Tan skin, broken nose, short dark hair, black beard streaked grey; sleeveless slate-blue tunic and leather wrist wraps.

**Consistency:** Not Silver: dark hair/beard and blue tunic without Silver apron.
...
Six additional character-and-workstation compositions are in `work-references/`. Review `work-references/review.jpg` and `work-references/manifest.json`. Actions: Chisel ready, Chisel contact, Measure stone, Dress stone, Lay masonry, Carry stone. These are static references; animation variations are the next pass.
