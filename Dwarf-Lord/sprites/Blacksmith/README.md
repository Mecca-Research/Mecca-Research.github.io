...
**Role:** Blacksmith design; Grit.

**Age:** Adult.

**Identity:** Deep brown skin, broad nose, thick black beard with bronze cuffs, bald head; charcoal smith apron and cream sleeves.

**Consistency:** Keep skin tone, facial structure and black beard; not a recolored dwarf laborer.
...
Six additional character-and-workstation compositions are in `work-references/`. Review `work-references/review.jpg` and `work-references/manifest.json`. Actions: Anvil ready, Hammer raised, Hammer contact, Inspect tool, File tool edge, Repair pickaxe handle. These are static references; animation variations are the next pass.
